...
namespace vrScraper.DB.Migrations
{
    ...
    [Migration("20260502003402_AddDailySnapshot")]
    partial class AddDailySnapshot
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("vrScraper.DB.Models.DbDailySnapshot", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("vrScraper.DB.Models.DbVideoEngagement", b =>
                {
                    b.Property<long>("VideoId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("BackwardScrubCount")
                        .HasColumnType("INTEGER");

                    b.Property<DateTime?>("LastSessionUtc")
                        .HasColumnType("TEXT");

                    b.Property<int>("OpenCount")
                        .HasColumnType("INTEGER");

                    b.Property<double>("ScrubCoveragePercent")
                        .HasColumnType("REAL");

                    b.Property<int>("ScrubEventCount")
                        .HasColumnType("INTEGER");

                    b.HasKey("VideoId");

                    b.ToTable("VideoEngagements");
                });
            ...
            modelBuilder.Entity("vrScraper.DB.Models.DbVideoEngagement", b =>
                {
                    b.HasOne("vrScraper.DB.Models.DbVideoItem", "Video")
                        .WithOne("Engagement")
                        .HasForeignKey("vrScraper.DB.Models.DbVideoEngagement", "VideoId")
